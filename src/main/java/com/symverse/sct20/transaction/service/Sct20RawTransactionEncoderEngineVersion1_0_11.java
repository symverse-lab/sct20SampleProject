...
public class Sct20RawTransactionEncoderEngineVersion1_0_11 {
	
	static final Logger logger = LoggerFactory.getLogger(Sct20RawTransactionEncoderEngineVersion1_0_11.class);
